const STRINGS = {
    logLandingHelp: "The logbook will be filled with a random amount of landings, depending on function. The generated landings will be correct for night/day.",
    ...
    defaultFunctionHelp: "If there is no function information on the monthly overview (ie. a KLC monthly) this function will be applied.<ul>" +
                         ...
                         "<li>SO is still WIP, means FO for now.",
    removeSimTypesHelp: "Remove all types from simulators so you can add them manually (with a pen or pdf editor). If you check both this and \"Guess simulator type\" it will re-guess all types.",
    // ... other strings ...
};