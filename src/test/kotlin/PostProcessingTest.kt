...
class PostProcessingTest {
    ...
    fun testGeneralPostProcess(){
        ...
        val processedFlights = GeneralPostProcessor.postProcess(flights, PreferencesData(logLanding = false, guessSimType = true, removeSimTypes = false, PreferencesData.FO))
