...
class PostProcessingTest {
    ...
    fun testGeneralPostProcess(){
        ...
        val processedFlights = GeneralPostProcessor.postProcess(flights, PreferencesData.DEFAULT.copy(logLanding = false, guessSimType = true, removeSimTypes = false, defaultFunction = PreferencesData.FO))
